...
<div class="card-table">
    <table class="table-modern">
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <a href="javascript:void(0);" 
                                onclick="confirmDelete('http://localhost/web_qlsp/product_list/delete/<?php echo $p['id']; ?>')"
                                class="btn-icon text-danger" 
                                title="Xóa">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5" style="width:20px;">
            ...
            <script src="http://localhost/web_qlsp/Public/js/products.js"></script>
        </tbody>
    </table>
</div>