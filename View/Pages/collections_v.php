...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button type="button" class="btn-primary-custom" data-bs-toggle="modal" data-bs-target="#addCollectionModal">
        <i class="fas fa-plus me-2"></i> Thêm Bộ Sưu tập
    </button>
</div>
...
<div class="card-table">
    ...
    <div class="p-3 border-bottom d-flex align-items-center bg-white">
        <form method="POST" action="http://localhost/web_qlsp/collections/search"
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href="http://localhost/web_qlsp/collections/delete/<?php echo $c['id']; ?>"
                                    class="btn-icon text-danger"
                                    onclick="return confirm('Xóa BST này?')"
                                    title="Xóa">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="http://localhost/web_qlsp/collections/update">
...
<div class="modal fade" id="addCollectionModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="http://localhost/web_qlsp/collections/add">
                    <div class="mb-3">
                        <label class="form-label">Tên Bộ sưu tập</label>
